 ...
 * i) nula/vacia, invoca al controlador Aviones, método index y parametros[] y renderiza vista principal
...
class Control
{
  ...
  protected $controlador = "Aviones";//define controlador principal
